...
//  Pods
//
//  Created by 杨建祥 on 2020/1/30.
//

#import <UIKit/UIKit.h>

/**
 * `RCFLabel`支持通过`contentEdgeInsets`属性来实现类似padding的效果。
 *
...
/// 点击了“复制”后的回调
@property(nonatomic, copy) void (^didCopyBlock)(RCFLabel *label, NSString *stringCopied);
